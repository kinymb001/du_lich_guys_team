...
<nav class="navbar navbar-dark fixed-top bg-dark flex-md-nowrap p-0 shadow">
  <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="#">Admin Du Lịch GUYs Team</a>
        ...
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?=$baseUrl?>category">
              ...
              Danh Sách Các Loại Tour
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?=$baseUrl?>tour">
              <i class="bi bi-file-earmark-text"></i>
              Danh Sách Chi Tiết Gói Tour
            </a>
          </li>
          <li class="nav-item">
