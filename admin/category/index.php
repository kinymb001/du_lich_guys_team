<?php
	$title = 'Quản Lý Danh Sách Các Loại Tour';
	$baseUrl = '../';
...
<div class="row" style="margin-top: 20px;">
	<div class="col-md-12" style="margin-bottom: 20px;">
		<h3>Quản Lý Danh Sách Các Loại Tour</h3>
	</div>
	<div class="col-md-6">
		<form method="post" action="index.php" onsubmit="return validateForm();">
			<div class="form-group">
			  <label for="usr" style="font-weight: bold;">Tên Loại Tour:</label>
...
<script type="text/javascript">
	function deleteCategory(id) {
		option = confirm('Bạn có chắc chắn muốn xoá loại tour này không?')
		if(!option) return;
