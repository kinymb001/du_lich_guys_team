<?php
	$title = 'Quản Lý Chi Tiết Gói Tour';
	$baseUrl = '../';
...
<div class="row" style="margin-top: 20px;">
	<div class="col-md-12 table-responsive">
		<h3>Quản Lý Chi Tiết Gói Tour</h3>

		<a href="editor.php"><button class="btn btn-success">Thêm Gói Tour</button></a>
...
<script type="text/javascript">
	function deleteProduct(id) {
		option = confirm('Bạn có chắc chắn muốn xoá gói tour này không?')
		if(!option) return;
