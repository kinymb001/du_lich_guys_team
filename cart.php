...
?>
		...
		<a href="checkout.php"><button class="btn_hb" style="border-radius: 0px; font-size: 26px;">TIẾP TỤC THANH TOÁN</button></a>
	</div>
</div>
<script type="text/javascript">
	...
	function updateCart(productId, num, ngay_khoi_hanh) {
