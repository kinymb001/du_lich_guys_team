	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<input type="date" name="ngay_khoi_hanh">
				<a href="cart.php">
				<button class="btn_hb" style="margin-top: 20px; width: 100%; border-radius: 0px; font-size: 30px;" onclick="addCart(<?=$product['id']?>, $('[name=num]').val(), $('[name=ngay_khoi_hanh]').val())">
				<i class="bi bi-cart-plus-fill"></i> Đặt Tour
			</button>
			</a>
